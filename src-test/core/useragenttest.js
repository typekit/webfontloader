...
UserAgentTest.prototype.testBrowserIsFirefoxLettersVersion = function() {
  var userAgentParser = new webfont.UserAgentParser("Mozilla/5.0 (X11; U; " +
      "Linux i686; ru-RU; rv:1.9.2a1pre) Gecko/20090405 Ubuntu/9.04 (jaunty) " +
      "Firefox/3.6a1pre");
  var userAgent = userAgentParser.parse();
...
UserAgentTest.prototype.testBrowserIsIELetterVersion = function() {
  var userAgentParser = new webfont.UserAgentParser(
      "Mozilla/4.0 (compatible; MSIE 7.0b; Windows NT 5.1; Media Center " +
      "PC 3.0; .NET CLR 1.0.3705; .NET CLR 1.1.4322; .NET CLR 2.0.50727; " +
      "InfoPath.1)");
  var userAgent = userAgentParser.parse();
...
UserAgentTest.prototype.testBrowserIsOpera = function() {
  var userAgentParser = new webfont.UserAgentParser("Opera/9.80 (Linux i686; " +
      "U; en) Presto/2.5.22 Version/10.51");
  var userAgent = userAgentParser.parse();
...
UserAgentTest.prototype.testBrowserIsOperaBeforeVersion10 = function() {
  var userAgentParser = new webfont.UserAgentParser("Opera/9.64 (X11; Linux " +
      "i686; U; Linux Mint; nb) Presto/2.1.1");
  var userAgent = userAgentParser.parse();
...
UserAgentTest.prototype.testBrowserIsIPod = function() {
  var userAgentParser = new webfont.UserAgentParser(
      "Mozilla/5.0 (iPod; U; CPU iPhone OS 2_2_1 like Mac OS X; en-us) " +
...
UserAgentTest.prototype.testBrowserIsSafariWithPlusVersion = function() {
  var userAgentParser = new webfont.UserAgentParser(
      ...
      "AppleWebKit/528.4+ (KHTML, like Gecko) Version/4.0dp1 Safari/526.11.2");
  var userAgent = userAgentParser.parse();
...
UserAgentTest.prototype.testBrowserGeckoShouldSupportWebFont = function() {
  var userAgentParser = new webfont.UserAgentParser(
      "Mozilla/5.0 (Windows; U; Windows NT 5.1; ru-RU; rv:1.9.1.4) " +
...
UserAgentTest.prototype.testBrowserGeckoNotExistingVersionShouldSupportWebFont = function() {
  var userAgentParser = new webfont.UserAgentParser(
      "Mozilla/5.0 (Windows; U; Windows NT 5.1; ru-RU; rv:2.5.8) " +
      "Gecko/20091016 (.NET CLR 3.5.30729)");
  var userAgent = userAgentParser.parse();
...
UserAgentTest.prototype.testBrowserGeckoVer110ShouldSupportWebFont = function() {
  var userAgentParser = new webfont.UserAgentParser(
      "Mozilla/5.0 (Windows; U; Windows NT 5.1; ru-RU; rv:1.10.1b) " +
      "Gecko/20091016 (.NET CLR 3.5.30729)");
  var userAgent = userAgentParser.parse();
...
UserAgentTest.prototype.testBrowserGeckoWeirdVerShouldNotSupportWebFont = function() {
  var userAgentParser = new webfont.UserAgentParser(
      "Mozilla/5.0 (Windows; U; Windows NT 5.1; ru-RU; rv:1.b) " +
      "Gecko/20091016 (.NET CLR 3.5.30729)");
  var userAgent = userAgentParser.parse();
...
UserAgentTest.prototype.testBrowserGeckoNoSubVerShouldNotSupportWebFont = function() {
  var userAgentParser = new webfont.UserAgentParser(
      "Mozilla/5.0 (Windows; U; Windows NT 5.1; ru-RU; rv:1.9) " +
      "Gecko/20091016 (.NET CLR 3.5.30729)");
  var userAgent = userAgentParser.parse();
